...
import org.mjbot.service.KlineQueryService;
...
/**
 * REST controller for managing {@link org.mjbot.domain.Kline}.
 */
@RestController
@RequestMapping("/api")
public class KlineResource {
    ...
    public ResponseEntity<KlineDTO> updateKline(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, klineDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<KlineDTO> partialUpdateKline(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, klineDTO.getId().toString())
        );
    }
