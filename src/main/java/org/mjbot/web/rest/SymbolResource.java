...
import org.mjbot.service.SymbolQueryService;
import org.mjbot.service.SymbolService;
...
/**
 * REST controller for managing {@link org.mjbot.domain.Symbol}.
 */
@RestController
@RequestMapping("/api")
public class SymbolResource {
    ...
    public ResponseEntity<SymbolDTO> updateSymbol(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, symbolDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<SymbolDTO> partialUpdateSymbol(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, symbolDTO.getId().toString())
        );
    }
