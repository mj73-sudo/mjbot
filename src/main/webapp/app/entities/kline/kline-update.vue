  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2 id="mjbotApp.kline.home.createOrEditLabel" data-cy="KlineCreateUpdateHeading">Create or edit a Kline</h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" for="kline-time">Time</label>
            <input
              type="number"
              class="form-control"
              name="time"
          ...
          <div class="form-group">
            <label class="form-control-label" for="kline-open">Open</label>
            <input
              type="text"
              class="form-control"
              name="open"
          ...
          <div class="form-group">
            <label class="form-control-label" for="kline-close">Close</label>
            <input
              type="text"
              class="form-control"
              name="close"
          ...
          <div class="form-group">
            <label class="form-control-label" for="kline-high">High</label>
            <input
              type="text"
              class="form-control"
              name="high"
          ...
          <div class="form-group">
            <label class="form-control-label" for="kline-low">Low</label>
            <input
              type="text"
              class="form-control"
              name="low"
          ...
          <div class="form-group">
            <label class="form-control-label" for="kline-volume">Volume</label>
            <input
              type="text"
              class="form-control"
              name="volume"
          ...
          <div class="form-group">
            <label class="form-control-label" for="kline-turnover">Turnover</label>
            <input
              type="text"
              class="form-control"
              name="turnover"
          ...
          <div class="form-group">
            <label class="form-control-label" for="kline-timeType">Time Type</label>
            <input
              type="text"
              class="form-control"
              name="timeType"
          ...
          <div class="form-group">
            <label class="form-control-label" for="kline-symbol">Symbol</label>
