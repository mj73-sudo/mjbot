  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2 id="mjbotApp.symbol.home.createOrEditLabel" data-cy="SymbolCreateUpdateHeading">Create or edit a Symbol</h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" for="symbol-symbol">Symbol</label>
            <input
              type="text"
              class="form-control"
              name="symbol"
            ...
            <div v-if="$v.symbol.symbol.$anyDirty && $v.symbol.symbol.$invalid">
              <small class="form-text text-danger" v-if="!$v.symbol.symbol.required"> This field is required. </small>
            </div>
          </div>
          <div class="form-group">
            <label class="form-control-label" for="symbol-name">Name</label>
            <input
              type="text"
              class="form-control"
              name="name"
            ...
            <div v-if="$v.symbol.name.$anyDirty && $v.symbol.name.$invalid">
              <small class="form-text text-danger" v-if="!$v.symbol.name.required"> This field is required. </small>
            </div>
          </div>
          <div class="form-group">
            <label class="form-control-label" for="symbol-baseCurrency">Base Currency</label>
            <input
              type="text"
              class="form-control"
              name="baseCurrency"
          ...
          <div class="form-group">
            <label class="form-control-label" for="symbol-quoteCurrency">Quote Currency</label>
            <input
              type="text"
              class="form-control"
              name="quoteCurrency"
          ...
          <div class="form-group">
            <label class="form-control-label" for="symbol-feeCurrency">Fee Currency</label>
            <input
              type="text"
              class="form-control"
              name="feeCurrency"
          ...
          <div class="form-group">
            <label class="form-control-label" for="symbol-market">Market</label>
            <input
              type="text"
              class="form-control"
              name="market"
          ...
          <div class="form-group">
            <label class="form-control-label" for="symbol-baseMinSize">Base Min Size</label>
            <input
              type="text"
              class="form-control"
              name="baseMinSize"
          ...
          <div class="form-group">
            <label class="form-control-label" for="symbol-quoteMinSize">Quote Min Size</label>
            <input
              type="text"
              class="form-control"
              name="quoteMinSize"
          ...
          <div class="form-group">
            <label class="form-control-label" for="symbol-baseMaxSize">Base Max Size</label>
            <input
              type="text"
              class="form-control"
              name="baseMaxSize"
          ...
          <div class="form-group">
            <label class="form-control-label" for="symbol-quoteMaxSize">Quote Max Size</label>
            <input
              type="text"
              class="form-control"
              name="quoteMaxSize"
          ...
          <div class="form-group">
            <label class="form-control-label" for="symbol-baseIncrement">Base Increment</label>
            <input
              type="text"
              class="form-control"
              name="baseIncrement"
          ...
          <div class="form-group">
            <label class="form-control-label" for="symbol-quoteIncrement">Quote Increment</label>
            <input
              type="text"
              class="form-control"
              name="quoteIncrement"
          ...
          <div class="form-group">
            <label class="form-control-label" for="symbol-priceIncrement">Price Increment</label>
            <input
              type="text"
              class="form-control"
              name="priceIncrement"
          ...
          <div class="form-group">
            <label class="form-control-label" for="symbol-priceLimitRate">Price Limit Rate</label>
            <input
              type="text"
              class="form-control"
              name="priceLimitRate"
          ...
          <div class="form-group">
            <label class="form-control-label" for="symbol-minFunds">Min Funds</label>
            <input
              type="text"
              class="form-control"
              name="minFunds"
          ...
          <div class="form-group">
            <label class="form-control-label" for="symbol-isMarginEnabled">Is Margin Enabled</label>
            <input
              type="checkbox"
              class="form-check"
          ...
          <div class="form-group">
            <label class="form-control-label" for="symbol-enableTrading">Enable Trading</label>
            <input
              type="checkbox"
              class="form-check"
              name="enableTrading"
          ...
          <div class="form-group">
            <label class="form-control-label" for="symbol-active">Active</label>
            <input
              type="checkbox"
              class="form-check"
              name="active"
