<template>
  <div>
    <h2 id="page-heading" data-cy="SymbolHeading">
      <span id="symbol-heading">Symbols</span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="mjbotApp.symbol.delete.question" data-cy="symbolDeleteDialogHeading">Confirm delete operation</span></span
      >
      <div class="modal-body">
        <p id="jhi-delete-symbol-heading">Are you sure you want to delete this Symbol?</p>
      </div>
